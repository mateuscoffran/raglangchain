...
st.subheader("Análise de documentos usando LangChain e RAG")

# Componentes interativos
file_input = st.file_uploader("Faça upload de um pdf", type=['pdf', 'txt', 'csv', 'docx', 'jpeg', 'png'])
openaikey = st.text_input("Digite a sua API Key da OpenAI", type='password')
prompt = st.text_area("Digite sua mensagem/pergunta sobre o documento", height=160)
run_button = st.button("Run!")

select_k = st.slider("Quantidade de chunks", min_value=1, max_value=5, value=2)
